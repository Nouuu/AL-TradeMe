...
@ApplicationScoped
public class RetrieveContractorsInvoicesService implements QueryHandler<RetrieveContractorsInvoices, List<Invoice>> {
    private final Invoices invoices;

    public RetrieveContractorsInvoicesService(Invoices invoices) {
        this.invoices = Objects.requireNonNull(invoices);
    }

    @Override
    public List<Invoice> handle(RetrieveContractorsInvoices query) {
        return invoices.getContractorsInvoices();
    }
}
