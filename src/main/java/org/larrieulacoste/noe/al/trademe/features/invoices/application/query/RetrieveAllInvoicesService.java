...
@ApplicationScoped
public class RetrieveAllInvoicesService implements QueryHandler<RetrieveAllInvoices, List<Invoice>> {
    private final Invoices invoices;

    public RetrieveAllInvoicesService(Invoices invoices) {
        this.invoices = Objects.requireNonNull(invoices);
    }

    @Override
    public List<Invoice> handle(RetrieveAllInvoices query) {
